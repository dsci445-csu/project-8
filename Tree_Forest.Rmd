...
predicted_vs_actual_plot_v1 <- final_predictions_dollars %>%
...
print(predicted_vs_actual_plot_v1)

saveRDS(predicted_vs_actual_plot_v1, "TreePlots/initial_RF_pred_v_actual.rds")
```
...
saveRDS(predicted_vs_actual_plot, "TreePlots/predicted_vs_actual_plot.rds")
```
```{r}

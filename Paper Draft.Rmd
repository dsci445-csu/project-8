...
### Kaitlynn: 
The variables I worked with were genre, rating, and stars. Since they were all categorical, I used frequency tables to visually see how much each category occurs. After that I did a chi-sq test and contingency function to compare the frequencies and see if there was any high correlation. 

...
```{r code I need for the plots to work}
...
Good to use if predictors are highly correlated, avoids overfitting and manages 
model complexity.
...
Grid of 400 different parameter combinations
Each combo used to compute metrics like RMSE, MAE, and R^2

The best RMSE (lowest) was pulled out and revealed the ideal lambda and alpha 
values. 
...
** Demonstrates stability as it performs very similarly between cross-validation and full-data predictions. 

...
Logistic regression was an obvious first choice in tackling this binary classification problem. We created 3 models to assess predictive performance with different regularization methods.

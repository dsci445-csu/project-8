...
From this code we conclude that there are only 13 predictive variables we should consider. 

We also looked into the accuracy of the SVM model this allows us to understand its predictive capabilities. We conclude that this model will have an accuracy of 0.817 this indicates the model has a 81.7% of making correct predictions. This code also created a confusion matrix, from this we can see the predicted and actual values using the Random Forest model. 
